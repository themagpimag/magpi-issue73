...
#include "Tiles.h"
#include "math.h" // we need to use a couple of maths functions, like floor,and sqrt
#include "Text.h"
...
// here you can define a scale factor from 1 to ..almost anything, but 8 is about the limit for a nice screen on a 1920*1080 display
// fraction values and values below 1 are possible but the results can be unwelcome, 4 provides a good retro look
...
// this is a new map, but the principles are he same, though we will test a tiles attributes not the tile value
	...
	int Map2[40][64] = { 
		...
		{ 4, 12, 12, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 4, 4, 13, 13, 13, 13, 13, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 4 },
...
// we might need the map coordinate of the tiles	
	float ScX, ScY;
	Text* MyText;
