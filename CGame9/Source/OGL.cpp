...
// into a Program Object which we will set as the default
	...
	init_EGL(&state, scr_width, scr_height); // this will set up the EGL stuff, its complex so put in a seperate method
...
/**********************************************************************/	
// another vertex shader but this is only used by the FastUpdate systems
